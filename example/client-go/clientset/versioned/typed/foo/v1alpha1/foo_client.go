...
// FooV1alpha1Client is used to interact with features provided by the foo.opendefense.cloud group.
...
func (c *FooV1alpha1Client) ClusterBars() ClusterBarInterface {
	return newClusterBars(c)
}
...
func setConfigDefaults(config *rest.Config) {
	gv := foov1alpha1.SchemeGroupVersion
